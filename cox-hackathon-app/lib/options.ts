...
export const ROOF_OPTIONS: RoofOption[] = [
  ...
  },
  {
    ...
    bestFor: 'Post-1980 flat roofs. Warehouses, retail, and low-rise office buildings.',
    requiresFlatRoof: true,
  },
  {
    ...
    bestFor: 'Modern low-rise buildings (post-2000) with reinforced flat roofs. Community or retail use.',
    requiresFlatRoof: true,
  },
  {
    id: 'rainwater',
    ...
    warningFlags: [],
    bestFor: 'Flat commercial roofs. Best paired with green roof or cool roof.',
    requiresFlatRoof: true,
  },
  {
    id: 'beekeeping',
    ...
    fullDescription: 'Atlanta permits rooftop beehives (City Code § 114-434). 2-hive setup: 100–200 lbs honey/yr plus pollination contracts. Fastest ROI of any option. Requires accessible flat roof at manageable height — practical limit is approximately 6 stories (60–70 ft). Above this height OSHA fall-protection requirements apply and carrying full honey supers (50+ lbs) becomes unsafe.',
    costFixed: 4000, annualRevenueFixed: 3500, co2TonsPerYear: 0.2,
    structuralLoadPSF: 1, feasibilityBase: 92,
    rebates: [],
    warningFlags: [
      'Requires City of Atlanta beekeeping permit',
      'Check lease restrictions',
      'Not suitable for buildings taller than ~6 stories — hive management at height is unsafe',
    ],
    bestFor: 'Low-rise flat-roof buildings (under ~6 stories). Strongest near restaurants or retail.',
    requiresFlatRoof: true,
  },
]
